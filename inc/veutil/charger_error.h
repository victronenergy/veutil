...
/* NOTE: DO NOT DEFINE NEW ERRORS IN THIS FILE! THIS FILE IS A COPY! */
...
#define CHARGER_ERROR_GFCI_FAULT							42	/*!< Error   / Inverter shutdown (panel isolation residual current too high) */
...
#define CHARGER_ERROR_LINK_SETTINGS_ISSUE					69  /*!< Error   / Network misconfigured */
#define CHARGER_ERROR_LINK_DEVICE_NOT_CAPABLE				70  /*!< Error   / Network misconfigured */
#define CHARGER_ERROR_LINK_PROTOCOL_VERSION					71  /*!< Error   / Network misconfigured */
...
#define CHARGER_ERROR_INPUT_SHUTDOWN_FAST_OVERVOLT_MAN_RST	81  /*!< Error   / Input shutdown (converter broken, short input to avoid battery overcharge) caused by fast overvoltage -> manual reset allowed after power-cycle */
#define CHARGER_ERROR_INPUT_SHUTDOWN_HIGH_OVERVOLT_MAN_RST	82  /*!< Error   / Input shutdown (converter broken, short input to avoid battery overcharge) caused by too high overvoltage -> manual reset allowed after power-cycle */
#define CHARGER_ERROR_INPUT_SHUTDOWN_OFF_CURRENT_MAN_RST	83  /*!< Error   / Input shutdown (converter broken, short input to avoid battery overcharge) caused by current detected when off -> manual reset allowed after power-cycle */
#define CHARGER_ERROR_INPUT_SHUTDOWN_OVERVOLT				84  /*!< Error   / Input shutdown (converter broken, short input to avoid battery overcharge) caused by slow overvoltage -> reset after power-cycle */
#define CHARGER_ERROR_INPUT_SHUTDOWN_FAST_OVERVOLT			85  /*!< Error   / Input shutdown (converter broken, short input to avoid battery overcharge) caused by fast overvoltage -> reset after power-cycle  */
#define CHARGER_ERROR_INPUT_SHUTDOWN_HIGH_OVERVOLT			86  /*!< Error   / Input shutdown (converter broken, short input to avoid battery overcharge) caused by too high overvoltage -> reset after power-cycle  */
#define CHARGER_ERROR_INPUT_SHUTDOWN_OFF_CURRENT			87  /*!< Error   / Input shutdown (converter broken, short input to avoid battery overcharge) caused by current detected when off -> reset after power-cycle  */
...
#define CHARGER_ERROR_KWH_COUNTERS_INVALID					123 /*!< Error   / kWh counters invalid/corrupted */
...
#define CHARGER_ERROR_BATTERY_TEMP_TOO_HIGH_WARN			150 /*!< Warning / Battery temperature too high */
#define CHARGER_ERROR_BATTERY_TEMP_TOO_LOW_WARN				151 /*!< Warning / Battery temperature too low */
...
#define CHARGER_ERROR_CHARGER_TEMP_TOO_HIGH_WARN			160 /*!< Warning / Charger temperature too high */
#define CHARGER_ERROR_CHARGER_SHORT_CIRCUIT_WARN			161 /*!< Warning / Charger short circuit */
#define CHARGER_ERROR_CHARGER_CONVERTER_ISSUE_WARN			162 /*!< Warning / Charger issue with power stage */
...
#define CHARGER_ERROR_INTERNAL_GFCI_FAILURE					202 /*!< Error   / Internal error */
