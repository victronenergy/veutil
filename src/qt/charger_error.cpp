#include <veutil/charger_error.h>
#include <veutil/base/compiler.h>
...
const VeChargerError ChargerError::errors[] =
{
	...
	{ CHARGER_ERROR_INPUT_SHUTDOWN_OVERVOLT_MAN_RST,		QT_TR_NOOP("PV Input shutdown") },
	{ CHARGER_ERROR_INPUT_SHUTDOWN_FAST_OVERVOLT_MAN_RST,	QT_TR_NOOP("PV Input shutdown") },
	{ CHARGER_ERROR_INPUT_SHUTDOWN_HIGH_OVERVOLT_MAN_RST,	QT_TR_NOOP("PV Input shutdown") },
	{ CHARGER_ERROR_INPUT_SHUTDOWN_OFF_CURRENT_MAN_RST,		QT_TR_NOOP("PV Input shutdown") },
	{ CHARGER_ERROR_INPUT_SHUTDOWN_OVERVOLT,				QT_TR_NOOP("PV Input shutdown") },
