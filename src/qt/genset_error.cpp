...
QString Cummins::getDescription(QString errorId)
{
	...
	switch (SpnAndFmiToNumber(spn, fmi)) {
		case SpnAndFmiToNumber(175,  0): return "#1 Oil temp exceeds limit";
		case SpnAndFmiToNumber(1675,14): return "#4 No start after 20 seconds";
		case SpnAndFmiToNumber(98,   1): return "#6 Oil level below minimum";
		case SpnAndFmiToNumber(2444, 0): return "#12 High output voltage";
		case SpnAndFmiToNumber(2444, 1): return "#13 Low output voltage";
		case SpnAndFmiToNumber(2436, 0): return "#14 High output frequency";
		case SpnAndFmiToNumber(2436, 1): return "#15 Low output frequency";
		case SpnAndFmiToNumber(51,   2): return "#19 Throttle actuator fault";
		case SpnAndFmiToNumber(8890, 0): return "#25 High internal voltage";
		case SpnAndFmiToNumber(8890, 1): return "#26 Low internal voltage";
		case SpnAndFmiToNumber(589,  2): return "#27 System frequency unknown";
		case SpnAndFmiToNumber(168,  0): return "#29 High battery voltage";
		case SpnAndFmiToNumber(190,  0): return "#31 High engine speed";
		case SpnAndFmiToNumber(1675, 8): return "#32 Low cranking speed";
		case SpnAndFmiToNumber(9206, 0): return "#34 Inverter temp too high";
		case SpnAndFmiToNumber(190, 11): return "#36 Engine stopped, unknown";
		case SpnAndFmiToNumber(2448, 0): return "#38 Output over generator limit";
		case SpnAndFmiToNumber(190,  2): return "#45 Engine speed unknown";
		case SpnAndFmiToNumber(51,   0): return "#49 Throttle limit exceeded";
		case SpnAndFmiToNumber(1440,14): return "#52 Injector/lift pump faulty";
		case SpnAndFmiToNumber(175,  2): return "#53 Oil temp unknown";
		case SpnAndFmiToNumber(105,  2): return "#54 Manifold Air Temp unknown";
		case SpnAndFmiToNumber(102,  2): return "#56 MAP sensor unknown";
		case SpnAndFmiToNumber(2448, 6): return "#67 AC output short to ground";
		case SpnAndFmiToNumber(3353, 4): return "#81 System short detected";
		case SpnAndFmiToNumber(6814, 2): return "#82 Vent pressure unknown";
		case SpnAndFmiToNumber(234, 13): return "Controller error";
		default:
